...
def test_mock_gemini_structured_output(tmp_path):
    response = {"decisions": [{"tc_id": "TC-1", "impact": "HIGH", "confidence": .91, "direct_impact": True, "regression_needed": True, "reason": "저장 변경", "relevant_specifications": ["spec-p1-0"], "verification_points": ["재실행"], "recommended": True}], "token_usage": {"prompt_tokens": 100, "candidate_tokens": 20, "total_tokens": 120}}
