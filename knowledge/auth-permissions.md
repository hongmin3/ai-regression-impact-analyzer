...
## 비밀번호 해시 및 세션
<!-- akela: id=password-hash-session -->
...
## 로그인 실패 메시지 통일
<!-- akela: id=login-failure-message -->
...
## 역할(Role)과 권한 구조
<!-- akela: id=role-permission-structure -->
...
<!-- akela: id=admin-lockout-recovery -->
...
<!-- akela: id=audit-log-permissions -->
